# 沖縄台風ナビ - App Store Connect 用メタデータ（初回TestFlight / v0.9.3）
...
**日本語（4000文字以内）**
沖縄県内の台風情報を、気象庁とJTWC（米軍合同台風警報センター）の実データで取得し、進路・風速半径（34kt/50kt/64kt）を地図上にわかりやすく表示します。
...
**English**
Typhoon information for Okinawa Prefecture is retrieved from real data by the Japan Meteorological Agency and JTWC (Joint Typhoon Warning Center), and displayed clearly on the map showing track and wind radii (34kt/50kt/64kt).
...
- サポートURL / マーケティングURL の `example.com` は提出前に実URLへ置き換える
